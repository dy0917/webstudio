...
class SocialMedia extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('user_id, social_media_id', 'required'),
			array('user_id', 'numerical', 'integerOnly'=>true),
			array('social_media_id, social_media', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, user_id, social_media_id, social_media', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('social_media_id',$this->social_media_id,true);
